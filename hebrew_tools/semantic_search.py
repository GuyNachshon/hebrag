...
class HebrewSemanticSearch:
    ...
    def __init__(self, boost_visual_content: bool = True, context_window: int = 500):
        self.name = "hebrew_semantic_search"
        self.description = "Search Hebrew documents with semantic understanding and visual content awareness"
...
class ContextualRetriever:
    ...
    def __init__(self, preserve_relationships: bool = True, multimodal_aware: bool = True):
        self.name = "contextual_retriever"
        self.description = "Retrieve content while preserving text-visual relationships"
